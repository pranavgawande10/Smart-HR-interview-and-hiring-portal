      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: "24px" }}>
        ...
        <div style={{ position: "sticky", top: "24px" }}>
          <div style={{
            ...
            <h2 style={{ fontSize: "20px", fontWeight: "bold", color: "#0f172a", margin: "16px 0 4px" }}>
              {formData.name}
            </h2>
            <p style={{ color: "#0d9488", fontSize: "14px", fontWeight: "500", marginBottom: "16px" }}>
              {formData.position}
            </p>
              ...
              <div style={{ display: "grid", gap: "16px" }}>
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p style={{ color: "#0f172a", fontSize: "14px" }}>{profile.name}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p style={{ color: "#0f172a", fontSize: "14px" }}>{profile.email}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p style={{ color: "#0f172a", fontSize: "14px" }}>{profile.phone}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="3"
                      style={{ width: "100%", padding: "10px", border: "1px solid #e2e8f0", borderRadius: "8px", fontSize: "14px", resize: "vertical" }}
                    />
                  ) : (
                    <p style={{ color: "#0f172a", fontSize: "14px", lineHeight: "1.5" }}>{profile.bio}</p>
                  )}
                </div>
              </div>
            </div>
              ...
              <div style={{ display: "grid", gap: "16px" }}>
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p style={{ color: "#0f172a", fontSize: "14px" }}>{profile.position}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p style={{ color: "#0f172a", fontSize: "14px" }}>{profile.department}</p>
                  )}
                </div>
            ...
            <div style={{ marginBottom: "24px" }}>
              ...
              <div style={{ display: "grid", gap: "12px" }}>
                <label style={{ display: "flex", alignItems: "center", gap: "12px", cursor: "pointer" }}>
                  ...
                  />
                  <span style={{ fontSize: "14px", color: "#475569" }}>Email Notifications</span>
                </label>
                <label style={{ display: "flex", alignItems: "center", gap: "12px", cursor: "pointer" }}>
                  <input
                    type="checkbox"
                    ...
                    style={{ width: "18px", height: "18px", cursor: "pointer" }}
                  />
                  <span style={{ fontSize: "14px", color: "#475569" }}>Push Notifications</span>
                </label>
              </div>
            </div>
              ...
              <div style={{ display: "grid", gap: "16px" }}>
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p style={{ color: "#0f172a", fontSize: "14px" }}>{profile.preferences.language}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {isEditing ? (
                    ...
                    <p style={{ color: "#0f172a", fontSize: "14px" }}>{profile.preferences.timezone}</p>
                  )}
                </div>
              </div>
            </div>
      ...
      {showPasswordModal && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ marginBottom: "16px" }}>
              <label style={{ display: "block", fontSize: "13px", fontWeight: "500", marginBottom: "4px" }}>New Password</label>
              <input
                type="password"
            ...
            <div style={{ display: "flex", gap: "12px" }}>
              <button
                onClick={() => setShowPasswordModal(false)}
                style={{ flex: 1, padding: "10px", border: "1px solid #e2e8f0", borderRadius: "8px", background: "white", cursor: "pointer" }}
              >
                Cancel
              </button>
              <button
                onClick={handlePasswordChange}
                style={{ flex: 1, padding: "10px", background: "linear-gradient(135deg, rgb(20, 184, 166) 0%, rgb(14, 165, 233) 100%)", color: "white", border: "none", borderRadius: "8px", cursor: "pointer" }}
              >
                Update Password
              </button>
            </div>
