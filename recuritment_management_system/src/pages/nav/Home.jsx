    ...
    <div className="w-full relative overflow-hidden bg-slate-900 min-h-screen text-slate-200">
      ...
      <div className="relative z-10">
        ...
        <section className="py-24 px-6">
          <div className="max-w-5xl mx-auto rounded-3xl overflow-hidden relative shadow-2xl shadow-indigo-900/50 bg-slate-800/50 border border-slate-700/50 glass">
            {/* Inner Glow */}
            <div className="absolute inset-0 bg-gradient-to-r from-indigo-500/20 via-purple-500/20 to-cyan-500/20"></div>
            
            <div className="relative z-10 px-8 py-20 text-center">
              <h1 className="text-4xl md:text-5xl font-extrabold outfit-font mb-6 text-white">
                Transform Your Hiring Process Today
              </h1>
              <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto font-medium">
                Join top recruiters leveraging our platform to find, evaluate, and hire the best talent globally.
              </p>
              <button className="bg-white text-slate-900 px-10 py-4 rounded-xl font-bold shadow-xl hover:scale-105 hover:bg-indigo-50 transition-all duration-300">
