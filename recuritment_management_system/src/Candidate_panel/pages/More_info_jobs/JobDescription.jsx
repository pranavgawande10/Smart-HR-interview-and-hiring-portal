...
const jobData = {
  ...
  "amazon-backend-developer": {
    company: "Amazon",
    logo: "https://img.icons8.com/color/48/amazon-logo.png",
    ...
    salary: "₹5,000/hour",
    description: "Amazon Hyderabad is seeking a talented Backend Developer to build scalable server-side applications for our e-commerce platforms.",
    responsibilities: [
  ...
  if (!job) {
    return (
      <div style={{ padding: "40px", textAlign: "center" }}>
        <h2>Job not found</h2>
        <Link to="/candidate/jobs" style={{ color: "#0369a1" }}>Back to Jobs</Link>
      </div>
    );
  }
