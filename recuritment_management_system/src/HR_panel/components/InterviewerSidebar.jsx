...
const InterviewerSidebar = ({
  ...
  const menuItems = [
    { path: "/interviewer", label: "Dashboard", icon: <LayoutDashboard size={22} /> },
    { path: "/interviewer/applicants", label: "Applicants", icon: <Users size={22} /> },
    { path: "/interviewer/interviews", label: "Interviews", icon: <Calendar size={22} /> },
    { path: "/interviewer/profile", label: "Profile", icon: <UserCircle size={22} /> },
  ];
  ...
  const getLinkStyle = (isActive) => ({
    ...
    background: isActive
      ? "linear-gradient(135deg, rgba(139, 92, 246, 0.2) 0%, rgba(14, 165, 233, 0.1) 100%)"
      : "transparent",
    ...
    <div style={sidebarStyle}>
      ...
      <nav style={{ marginTop: "10px" }}>
        {menuItems.map((item) => (
          ...
          >
            <div style={{ color: "inherit", transition: "transform 0.3s ease" }}>{item.icon}</div>
